...
{
    public abstract class THUONGPROJECTWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static THUONGPROJECTWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(THUONGPROJECTWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<THUONGPROJECTDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<THUONGPROJECTDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<THUONGPROJECTDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<THUONGPROJECTDbContext, Task<T>> func)
        {
            T result;
