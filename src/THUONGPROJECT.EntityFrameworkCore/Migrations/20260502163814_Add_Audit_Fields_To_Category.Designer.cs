...
namespace THUONGPROJECT.Migrations
{
    ...
    [Migration("20260502163814_Add_Audit_Fields_To_Category")]
    partial class Add_Audit_Fields_To_Category
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("THUONGPROJECT.Categories.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("THUONGPROJECT.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("THUONGPROJECT.Authorization.Users.User", null)
                        .WithMany("Claims")
